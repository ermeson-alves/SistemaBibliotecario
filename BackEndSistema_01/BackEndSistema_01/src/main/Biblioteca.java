...
/**
 * Classe principal que armazena todas as obras e oferece métodos como inclusão
...
public class Biblioteca {
	 ...
	 * @param quantidadeCopias número de copias que serão adicionadas a coleção no
	 *                         momento de inserção da obra.
	 */
	public void adicionarObra(String nome, String autor, String editora, int quantidadeCopias) throws ObraExistenteException, ObraNomeVazioException {
		...
		if (nome!=null) {
			...
			if (achou_obra) {
				throw new ObraExistenteException("Essa obra já existe!");
			} else {
	...
	/**
	 * Fornece o objeto biblioteca que armazena na memória todas as obras e que só
	 * pode ser instanciado uma única vez.
	 * 
