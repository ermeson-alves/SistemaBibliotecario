...
/**
 * Classe que representa uma cópia de algum itém armazenável em um objeto do tipo Biblioteca.
 * 
...
public class Copia extends ModeloObra{// Existem atributos de uma obra presentes em copia
	...
	/**
	 * Realiza o empréstimo de um item e atualiza seu status para controle de informações.
	...
	/**
	 * Atualiza o status de um item ao ser devolvido para que ele esteja disponível novamente na coleção de itens.
	 */
