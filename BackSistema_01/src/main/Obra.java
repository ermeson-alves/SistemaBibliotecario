...
/**
 * Algum item que pode ser armazenado na biblioteca, com nome, autor, editora (se for o caso) e um array de copias desse item.
 * 
...
public class Obra extends ModeloObra{
	...
	/**
	 * Código único desse item, atribuído no momento de sua inserção em um objeto do tipo biblioteca.
	 */
